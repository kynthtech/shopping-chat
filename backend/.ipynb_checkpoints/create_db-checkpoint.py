...
# # cursor.executemany("INSERT INTO orders (user_id, order_date, total) VALUES (?, ?, ?)", [
# #     (1, "2025-08-01", 800.00),
# #     (2, "2025-08-02", 520.00),
# #     (3, "2025-08-05", 70.00)
# # ])

# # cursor.executemany("INSERT INTO order_items (order_id, product_id, quantity, price) VALUES (?, ?, ?, ?)", [
# #     (1, 1, 1, 750.00),
# #     (1, 3, 1, 50.00),
# #     (2, 2, 1, 500.00),
# #     (2, 5, 1, 20.00),
...
# 2. Define the SQL command with a single set of placeholders
sql_command = """
CREATE TABLE orders (
    order_id INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id INTEGER NOT NULL,
...
# 4. Use executemany() to insert all rows at once
...
print("✅ Successfully inserted multiple users.")